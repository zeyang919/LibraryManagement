...
<?php
	...
	$sql=mysqli_query($conn,"select r.id,r.barcode,r.name,t.name as typename,r.vocation,r.birthday,r.paperType,r.paperNO,r.tel,r.email,r.remark  from tb_reader as r join (select * from tb_readertype) as t on r.typeid=t.id where r.id='$_GET[id]'");
