...
do{ ?>
                   <tr>
                     ...
                     <td style="padding:5px;">&nbsp;<?php if(isset($_POST["barcode"])){echo $T=$info["backTime"];}?></td>
                     ...
                     <td width="12%" align="center"><a href="borrow_oncemore.php?barcode=<?php if(isset($_POST["barcode"])){echo $info["barcode"];}?>&borrid=<?php echo $info["borrid"];?>&backTime=<?php if(isset($_POST["barcode"])){echo $info["backTime"];}?>">续借</a>&nbsp;</td>
                   </tr>
