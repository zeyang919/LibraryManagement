...
<table width = '100%' border = '0' cellpadding = '0' cellspacing = '0' bordercolor = '#FFFFFF' bgcolor = '#9ECFEE' class = 'tableBorder_grey'>
<tr>
...
<tr>
<td height = '33' background = 'Images/bookborr.gif'>&nbsp;
</td>
</tr>
</table>
...
<input name = 'barcode' type = 'text' id = 'barcode' size = '24' value = "<?php if(isset($_POST["barcode"])&& isset($sql) && mysqli_num_rows($sql)!=0){echo $info["barcode"];}?>">
&nbsp;
...
<tr>
<td height = '27'>姓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名：
<input name = 'readername' type = 'text' id = 'readername' value = "<?php if(isset($_POST["barcode"])&& isset($sql) && mysqli_num_rows($sql)!=0){echo $info["name"];}?>">
<input name = 'readerid' type = 'hidden' id = 'readerid' value = "<?php if(isset($_POST["barcode"])&& isset($sql) && mysqli_num_rows($sql)!=0){echo $info["id"];}?>"></td>
<td>性&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别：
...
<td>可借数量：
<input name = 'number' type = 'text' id = 'number' value = "<?php if(isset($_POST["barcode"])&& isset($sql) && mysqli_num_rows($sql)!=0){echo $info["number"];}?>" size = '17'>
册
&nbsp;
</td>
</tr>
...
图书名称&nbsp;
&nbsp;
<input name = 'inputkey' type = 'text' id = 'inputkey' size = '40'>
...
//$sql = mysqli_query( $conn, "select t.days from tb_bookinfo b left join tb_booktype t on b.typeid=t.id where b.barcode='".$_POST[barcode]."'" );
if(mysqli_num_rows($sql1)!=0){
$info1 = mysqli_fetch_array( $sql1 );
$borrowNumber = mysqli_num_rows( $sql1 );
}
//获取结果集中行的数目
if(mysqli_num_rows($sql1)!=0 ){
do {
    ...
    <?php echo $info1['bookname'];
    ?></td>
    <td style = 'padding:5px;'>&nbsp;
    <?php echo $info1['borrowTime'];
    ?></td>
    <td style = 'padding:5px;'>&nbsp;
    <?php echo $info1['backTime'];
    ?></td>
    <td align = 'center'>&nbsp;
    <?php echo $info1['pubname'];
    ?></td>
    <td align = 'center'>&nbsp;
    <?php echo $info1['bookcase'];
    ?></td>
    <td width = '14%' align = 'center'>&nbsp;
    <?php echo $info1['price'];
    ?></td>
    </tr>
    <?php
}
